/*;
 * ftgplane.js - Manage a series of plane-aligned images for WebGL.
 * Version 1.0
 */
...
//
// ftgFramebuffer class
//
function ftgFramebuffer() {
    this.fb      = undefined;
    ...
    this.init = function() {
        ...
        this.fb.width = 512;  // todo: get this from the canvas
        this.fb.height = 512;
        
        // todo: we don't really want mips, do we?
