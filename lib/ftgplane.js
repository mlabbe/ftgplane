...
/* 
 * get a compiled shader program object
 ...
 */
ftg.drawPlaneToViewport = function() {
    var gl = ftg.gl;
    ...
    mat4.perspective( 45, gl.viewportWidth / gl.viewportHeight, 1.0, 4096, pMatrix );
    ...
    ftg.bindAndPoint( ftg.plane.boxVerts, ftg.mats.def.attr['aVertexPosition'] );
    ftg.bindAndPoint( ftg.plane.boxTexCoords, ftg.mats.def.attr['aTextureCoord'] );

    // Set up uniforms  fixme: not the right material
    gl.uniformMatrix4fv( ftg.mats.def.uniforms['uMVMatrix'], false, mvMatrix );
    gl.uniformMatrix4fv( ftg.mats.def.uniforms['uBoxMatrix'], false, boxMat );
    gl.uniformMatrix4fv( ftg.mats.def.uniforms['uPMatrix'], false, pMatrix );
...
function ftgMaterial() {
    ...
    this.initShaderValues = function() {
        ...
        this.getUniform( "uPMatrix" );
        this.getUniform( "uMVMatrix" );
        this.getUniform( "uBoxMatrix" );
...
function ftgRenderTarget() {
     ...
     * 
     * width, height - Dimensions of the rendertarget
     */
    this.init = function( width, height ) {
        ...
        //this.rbColor = ftg.initRBO( gl.RGBA4, this.fb.width, this.fb.height );
